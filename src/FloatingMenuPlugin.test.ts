...
import {createKeyMapPlugin} from '@modusoperandi/licit-doc-attrs-step';
...
describe('FloatingMenuPlugin', () => {
  ...
  describe('getDecorations', () => {
    ...
    it('should handle null doc', () => {
      ...
      const decorations = getDecorations(null as unknown as Node, mockState as EditorState);
  ...
  describe('createOnCloseHandler', () => {
    ...
    it('should handle null anchorEl', () => {
      ...
      const handler = createOnCloseHandler(mockPlugin, undefined);
